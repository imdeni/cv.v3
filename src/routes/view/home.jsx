...
import IsiContentName from "../component/home/ContentName"
...
export default function Home() {
  ...
  const [listmenu, setMenuShow] = useState(false);
  const listMenuShow = () => setMenuShow(true);
  const listMenuClose = () => setMenuShow(false);
  ...
  const cssChangerAboutPhone = () => {
    setBgColorAbout('cyan');
    setBgColorExp('#404040');
    setBgColorProject('#404040');
  };
  const cssChangerExpPhone = () => {
    setBgColorExp('cyan');
    setBgColorAbout('#404040');
    setBgColorProject('#404040');
  };
  const cssChangerProjectPhone = () => {
    setBgColorProject('cyan');
    setBgColorAbout('#404040');
    setBgColorExp('#404040');
  };
  ...
  return (
    <>
      ...
      <div className="bg-black bg-opacity-75 w-screen h-max">
        ...
        <div id="nav" className="z-40 fixed -mt-[40px]
        2xl:inset-x-1/4 
        2xl:-ml-[440px]
        invisible lg:visible lg:max-w-md xl:max-w-xl 2xl:max-w-3xl xl:py-16">
          <div className="px-8 py-2 lg:py-0">
            <div className="invisible xl:visible xl:-ml-[250px] 2xl:-ml-[450px]">
            ...
            <div className="grid grid-cols-4 gap-4 2xl:gap-6 lg:max-w-lg xl:max-w-xl 2xl:max-w-3xl ">
        ...
        <div className="grid grid-rows-[auto] justify-center lg:ml-[410px] xl:ml-[540px] 2xl:ml-[740px] lg:-mt-[40px] xl:mt-[20px]">
          <div className="pt-8 lg:pt-16" id="about">

            {/* Phone view */}
            <div className="block lg:hidden w-auto pl-10 pr-2 lg:px-0 lg:mx-8 my-2 rounded-xl max-w-5xl">
              <IsiContentName />
            </div>
            {/* End phone view */}

            <div className="mt-[10px] w-auto pl-10 pr-2 lg:px-0 lg:mx-8 my-2 rounded-xl max-w-5xl">
              <IsiConentAbout section="About" desc="desc_about" />
            </div>
          </div>

          <div className="pl-10 pr-2 lg:pl-8 lg:pr-8">
            <div id="experience" className="w-auto my-2 p-8 rounded-xl bg-zinc-900 grid gap-4 grid-rows max-w-5xl">
              ...
              <div className="px-4 py-1 rounded-lg bg-zinc-900 bg-[linear-gradient(45deg,transparent_25%,rgba(100,100,100,.9)_50%,transparent_75%,transparent_100%)]  w-fit">
                <h1 className="text-md lg:text-lg font-medium tracking-tight text-cyan-parent">{t('Experience')}</h1>
              </div>
          ...
          <div className="pl-10 pr-2 lg:pl-8 lg:pr-8">
            <div id="project" className="w-auto my-2 p-8 rounded-xl bg-zinc-900 grid gap-4 grid-rows max-w-5xl">
      ...
      {show == true &&
        <div className=" fixed z-[999] grid w-screen h-screen place-items-center bg-black bg-opacity-60 backdrop-blur-sm">
          <div className="relative m-4 w-fit lg:w-1/5 max-w-[70%] xs:max-w-[33.333333%] rounded-lg bg-zinc-500 font-sans text-base font-light leading-relaxed antialiased shadow-2xl">
      ...
      {listmenu == false &&
        <div className="block lg:hidden fixed left-0 top-10 w-[35px] max-w-[35px]">
          <div className="grid grid-rows-2">
            <Icon onClick={menuOpen} icon="solar:hamburger-menu-bold-duotone" className="w-full h-full text-white" />
            <p className="pl-[2px] text-xs text-center font-bold text-neutral-300">Menu</p>
          </div>
        </div>
      }
      {listmenu == false &&
        <div className="block lg:hidden fixed left-0 bottom-0 w-[35px] max-w-[35px]">
          <Icon onClick={(e) => {
            e.preventDefault();
            window.scrollTo({
              top: document.querySelector("#about").offsetTop,
            ...
            icon="mingcute:up-line" className="w-full h-full text-white" />
        </div>
      }
      {listmenu == true &&
        <div className="left-0 top-0 w-screen h-auto backdrop-blur-md fixed">
          <div className="grid grid-cols-2 gap-4 p-8">
            ...
            <div onClick={listMenuClose} >
              <ButtonView icon="BackspaceIcon" buttonName="Close menu" />
            </div>
          </div>
