    ...
    return (
        btnName !== "" ? (
            <div id="buttons" className="bg-transparent border-2 border-neutral-400 rounded-lg">
                <div className="grid grid-cols-[100px_minmax(auto,auto)] place-items-center gap-2">
                    <button id="x" className="pointer-events-none buttons bg-transparent rounded-lg w-full text-neutral-400">{t(btnName)}</button>
                    <div className={`signal-bars sizing-box ${jumlahBars}`}>
